...
class MainWindow:
    def __init__(self, master):
        ...
        self.Status.place(x = 20, y = 460)

        self.FilesLeft = Label(master, text = "Files left to download: 0")
        self.FilesLeft.place(x = 240, y = 460)
        ...
        self.ComboBox = Combobox(master, state= "readonly", values = ["Active Subscriptions", "Expired Subscriptions", "All Subscriptions"])
        ...
        self.RedownloadBool = tk.BooleanVar()
        self.RedownloadBool.set(False)
        self.Redownload = Checkbutton(master, text="Re-Download", variable=self.RedownloadBool)
        self.Redownload.place(x = 20, y = 430)

        self.LogText = tk.Text(master, height = 18, width = 48)
        self.LogText.place(x = 240, y = 40)

        self.ProgressBar = Progressbar(master, orient="horizontal", length=350, mode="determinate")
    ...
    def display_info(self, links):
        ...
        temp_str = "Download Size: " + File_Size_Str(total_size) + "\n"
        self.LogText.insert(tk.END, temp_str)
        ...
        if len(self.onlyfans.return_links()) > 0:
            ...
            if answer != False:
                ...
                if self.sort == True:
                    ...
                    self.onlyfans.all_files_size = Link_Size(files)
                else:
                ...
                #Write_Through_File(self.onlyfans)
